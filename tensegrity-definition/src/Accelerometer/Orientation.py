...
class Orientation:
    """This class will be used to determine which nodes of the tensegrity system are 'down' for any given accelerometer reading."""

    def __init__(self):
        self.accel = AccelerometerSimulator.AccelerometerSimulation()
        # self.mag = Magnetometer() - can be added back in in the future if we want to add/simulate a Magnetometer.
